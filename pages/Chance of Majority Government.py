...
st.set_page_config(page_title="Chance of Majrotiy Government in 2024 Australian Election", layout="wide")

# Optional: Repeat the title for clarity or styling
st.title("Chance of Majrotiy Government in 2024 Australian Election")
